...
public class Cart {
    ...
    public static void demo() {
        ...
        System.out.println("Adding inital Items : ");
        ...
        System.out.println("Addding Item Swiss Cheeset");

        Item swissCheese = ik.getObject(6, "Swiss Cheese", 6.49);
        objCart.itemList.add(swissCheese);
        objCart.showCartTotal();
        
        System.out.println("Addding Item Blue Cheese");
 ...
 public static void demo2() {
      ...
      System.out.println("Addding Item Swiss Cheese");
